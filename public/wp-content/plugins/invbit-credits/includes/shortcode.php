...
function invbit_credits_shortcode($atts) {
    ...
    <section class="invbit-credits-container">
        <div class="invbit-credits-row">
            ...
            <section class="invbit-credits-column invbit-credits-left">
                <h2 class="invbit-credits-title"><?= sprintf('Diseño y desarrollo web <span class="invbit-credits-project-type-label">%s</span> para %s', $project_type_labels[$options['project_type']]['description'], $options['title']); ?></h2>
            ...
            <aside class="invbit-credits-column invbit-credits-right">
                <div class="invbit-credits-company">
                    ...
                    <div class="invbit-credits-slogan">
                        <p><?= __('Un equipo de expertos en diseño web y marketing digital','base');?></p>
                    </div>
                    <div class="invbit-credits-contact">
                        <p>
                            <a href="https://tuempresa.com" target="_blank">
    ...
    <style>
        ...
        .invbit-credits-title {
            ...
            span {
                color: var(--primary, var(--plugin-color));
            }
        }
        ...
        .invbit-credits-feature-item {
            ...
            &::before {
                ...
                display: inline-flex;
                background: black;
                background-color: var(--primary, var(--plugin-color));
                width: var(--size);
                height: var(--size);
                border-radius: 50%;
                margin-right: .5rem;
